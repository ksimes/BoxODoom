...
public class BoxOfDoom implements MessageListener {
    ...
    public BoxOfDoom() {
        try {
            ...
            controllers.add(new ZoneController(ServoControllerNano, new PyroElectric(ZONE1, gpio), zone1Servos, "angry.mp3"));
            ...
            controllers.add(new ZoneController(ServoControllerNano, new PyroElectric(ZONE3, gpio), zone3Servos, "catscream.wav"));
            int[] zone4Servos = {12, 13, 14, 15};
            controllers.add(new ZoneController(ServoControllerNano, new PyroElectric(ZONE4, gpio), zone4Servos, "quick fight.mp3"));
